...
def predict(input_data: GesturePredictRequest):
    ...
    try:
        ...
        # Now 'model_pipeline' is the actual sklearn Pipeline object
        ...
        # Get confidence scores (if the classifier in the pipeline supports predict_proba)
        ...
        if hasattr(classifier_step, 'predict_proba'):
            ...
            # Map encoded predictions back to class names for confidence scores
        ...
        result = {
            "predicted_class_index": int(prediction_encoded), # More informative
